...
1. Check `AGENTS.md` / `CLAUDE.md` → File Dependencies
...
- Skills: `.agents/skills/` (Project, canonical) and `.agent/skills/` (legacy Antigravity-kit subset)
- Runtime Scripts: `<skills-dir>/<skill>/scripts/`
