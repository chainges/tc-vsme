		...
		<div className="min-h-screen bg-background text-foreground overflow-x-hidden">
				...
				<div className="container mx-auto px-4 md:px-6 relative z-10">
					<div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
							...
							>
								...
								<div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
									<Button
										asChild
										size="lg"
										className="btn-tactile bg-linear-to-r from-(--teal) to-(--sky) hover:opacity-90 text-white border-0 shadow-lg shadow-(--teal)/20"
									>
									...
									<Button
										size="lg"
										variant="outline"
										className="btn-tactile border-(--sky)/30 hover:bg-(--sky)/5 hover:border-(--sky) text-foreground min-w-[160px]"
									>
										Book demo
									</Button>
								</div>
						...
						<div className="flex-1 w-full max-w-[600px] lg:max-w-none relative perspective-1000">
							<motion.div
								initial={{ opacity: 0, rotateY: -4, scale: 0.96 }}
							...
							>
								<div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20 bg-background/50 backdrop-blur-sm group">
									<div className="absolute inset-0 bg-linear-to-tr from-(--teal)/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 ease-out pointer-events-none" />
									<img
			...
			<section className="py-10 border-y border-border/50 bg-muted/30">
				<div className="container mx-auto px-4 text-center">
					...
					<div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 opacity-70 grayscale hover:grayscale-0 transition-[filter,opacity] duration-200 ease-out">
					...
					<div className="grid md:grid-cols-3 gap-8 items-start">
						...
						<GlowingCard glowColor="sky" className="relative group">
							...
							<CardContent>
								...
								<Button className="btn-tactile w-full" variant="outline">
									Start nå
								</Button>
							</CardContent>
						</GlowingCard>
						...
						<GlowingCard
							glowColor="teal"
							className="relative border-(--teal) border-t-4 shadow-2xl scale-105 z-10"
						>
							<CardHeader>
							...
							<CardContent>
								...
								<Button className="btn-tactile w-full bg-(--teal) hover:bg-(--teal)/90 text-white shadow-lg shadow-(--teal)/25">
									Get Started
								</Button>
							</CardContent>
						</GlowingCard>
			...
			<section id="contact" className="py-24 bg-muted/50">
				<div className="container px-4 text-center max-w-4xl mx-auto">
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center">
						<Button
							size="lg"
							className="btn-tactile bg-foreground text-background hover:opacity-90 px-8 text-lg h-12"
						>
							Book Demo
						</Button>
						<Button
							size="lg"
							variant="outline"
							className="btn-tactile px-8 text-lg h-12 bg-background"
						>
							Kontakt Oss
						</Button>
					</div>
			...
			<section className="pt-20 pb-32">
				<div className="container px-4 md:px-6 max-w-3xl mx-auto">
					...
					<Accordion type="single" collapsible className="w-full space-y-4">
						...
						>
							<AccordionTrigger className="text-lg font-medium hover:no-underline hover:text-(--teal) py-4">
